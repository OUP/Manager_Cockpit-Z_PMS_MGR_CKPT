		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ManagerCockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManagerCockpit-display": {
								"semanticObject": "ManagerCockpit",
								"action": "display",
								"description": "Manager Cockpit Application",
								"title": "Manager Cockpit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.pms.zpmsmgrckpt",
									"url": sap.ui.require.toUrl("oup/pms/zpmsmgrckpt")
								}
							}
						}
					}
