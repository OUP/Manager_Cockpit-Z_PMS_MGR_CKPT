sap.ui.define(
  ...
  function (UIComponent, Device, models, ErrorHandler) {
    ...
    return UIComponent.extend("oup.pms.zpmsmgrckpt.Component", {
      metadata: {
        manifest: "json",
      ...
      _saveApplicationSate: function () {
        try {
          // create a new Application state (oAppState) for this Application instance
          const oAppState = sap.ushell.Container.getService(
          ...
          const sOldHash = oHashChanger.getHash();
          const sNewHash =
            sOldHash + "?" + "sap-iapp-state=" + oAppState.getKey();
